...
export class AgregarComponent implements OnInit {
  ...
  agregarItem(){
    if(this.resultsCity){
      ...
      this._dataService.listas.push([this.resultsCity, this.resultsTemp, this.resultsTempMax, this.resultsTempMin, this.resultsStatus]);
      ...
      this._dataService.listas.push([this.resultCity, this.resultTemp, this.resultTempMax, this.resultTempMin, this.resultStatus]);
      this._dataService.actualizarData();
    }
